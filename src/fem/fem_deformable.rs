...
pub struct FEMDeformable {
    ...
    pub Ws: Vec<Float>, // (Determinants divided by 6) of difference matrix of vertices of tetrahedra. i.e. undeformed volume of each tetrahedron. Volume = determminant / 6
